...
namespace BuatySalonWebApp.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        private readonly CheackEmailsUserService _cheackEmailsUserService;
        ...
        public ExternalLoginModel(
            ...
            IEmailSender emailSender,
             CheackEmailsUserService cheackEmailsUserService,
              ...
              RoleManager<IdentityRole> roleManager)
        {
            ...
            _cheackEmailsUserService = cheackEmailsUserService;
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //{
                //    bool contains = false;
                //    var listEmail = await _cheackEmailsUserService.GetAllListAsync();
                ...
                //    if (!contains)
                //    {
                //        ErrorMessage = "Error loading doesn't have permission.";
                //        return RedirectToPage("./Login", new { ReturnUrl = returnUrl });
                //    }
                //}
                var isRoleExists = await _roleManager.RoleExistsAsync("Admin");
                if (!isRoleExists)
                {
                ...
                isRoleExists = await _roleManager.RoleExistsAsync("User");
                if (!isRoleExists)
                {
                    var role = new IdentityRole();
                    role.Name = "User";
